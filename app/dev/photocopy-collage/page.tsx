...
const polaroids = [
  {
    src: "/dev/childhood-polaroid-1.jpeg",
    alt: "A child in a patterned dress holding a toy",
    surfaceClassName: styles.photoSurface,
  },
  {
    src: "/dev/childhood-polaroid-2.jpg",
...
export default function PhotocopyCollagePrototype() {
  return (
    <main className={styles.page}>
      <section className={styles.stage} aria-label="Photocopy collage prototype">
        <div className={styles.polaroidRow}>
          <HeartDoodle />
          {polaroids.map((polaroid, index) => (
            <div className={styles.polaroid} key={polaroid.src}>
              <div className={polaroid.surfaceClassName}>
                <Image
        ...
        <nav className={styles.actions} aria-label="Wedding links">
          <a className={styles.actionLink} href="#details">
            Details
          </a>
          <a className={styles.actionLink} href="#rsvp">
            RSVP
          </a>
        </nav>
      </section>
